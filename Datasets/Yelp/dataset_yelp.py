...
if __name__ == "__main__":
    ...
    if not os.path.exists('data_yelp/'):
        os.mkdir('data_yelp/')

    if not os.path.exists('data_yelp/Yelp_info.pkl'):
        sample.columns = ['user_id', 'item_id', 'clk']
        print("Numbers of raw samples: ", sample.shape[0])
        ...
        with open('data_video/Video_info.pkl', 'wb') as f:
            ...
            print("Dataset information generated.")
    else:
